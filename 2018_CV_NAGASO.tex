\documentclass[9pt,a4paper]{moderncv}
    ...
    \cvitem{description}{
        Development of software for acoustic signal processing and 3D visualization.\newline
        Development of computational simulation program for acoustic propagation analysis.\newline
    ...
    \section{Private development}
    % random walk
    \cvitem{subject}{\emph{Network clustering application}}
    \cvitem{description}{
        Implementation of hierarchal network clustering code based on Map equation and Modularity.\newline
        Louvain method is applied for the trial routine of cluster division.\newline
        Page rank calculation with power iteration method is used for calculation of initial transition provability.
    }
     
    % Nonlinear mixed effect library
    \cvitem{subject}{\emph{The numerical computation library for estimation of subject times}}
    \cvitem{description}{
        Python library for calculating the subject time (i.e. temporal position indicating the degree of progress in a disease) writen in C++ and wrapped by swig.\newline
        ...
        Golden searcha algorithm was also implemented during the routine.\newline
    ...
    \cvitem{subject}{\emph{Generation of semantic networks around popular products and generation of learning model for making a hit}}
    \cvitem{description}{
        ...
        Keywords: word2vec, semantic network, machine learning, SMOTE.
    }
    % web scraper
    \cvitem{subject}{\emph{Web scraping scripts}}
    \cvitem{description}{
        This is a set of scraping scripts developed for gathering texts from web for making semantic networks concerning the above project.\newline
    ...
    \cvline{Operating systems}{Linux (Debian, Ubuntu), OS X, Windows, (Slurm)}
    ...
    \cvline{Development environments}{Vim, Eclipse, NetBeans, Xcode, Microsoft Visual Studio, Visual Studio Code, Git, SVN, Redmine, Bitbucket}
